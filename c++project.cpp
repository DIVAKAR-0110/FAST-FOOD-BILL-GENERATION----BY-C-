...
const double SGST_RATE =0.03;
const double CGST_RATE = 0.02;
...
class food
{
  ...
  void displayBill(int n,ofstream &obj)
  {
    ...
    cout<<setw(10)<<"                              _____________________";
    cout<<endl<<setw(45)<<"SUBTOTAL"<<setw(35)<<total<<endl;
    cout<<setw(10)<<"                              _____________________"<<endl;
    ...
    obj<<setw(10)<<"                              _____________________";
    obj<<endl<<setw(45)<<"SUBTOTAL"<<setw(35)<<total<<endl;
    obj<<setw(10)<<"                              _____________________"<<endl;
